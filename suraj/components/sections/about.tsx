      ...
      <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
        ...
        >
          <div className="glass relative h-72 w-72 overflow-hidden rounded-2xl sm:h-80 sm:w-80">
            <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-indigo-500/20 to-purple-500/20">
              <span className="text-7xl font-bold text-indigo-400/50">
                {siteConfig.name[0]}
              </span>
            </div>
          </div>
        ...
        >
          {siteConfig.bio.map((paragraph, index) => (
            <p key={index} className="leading-relaxed text-slate-400">
              {paragraph}
            </p>
          ))}
          ...
          <div className="grid grid-cols-3 gap-4 pt-6">
            ...
            <div className="glass rounded-xl p-4 text-center">
              ...
              <div className="mt-1 text-xs text-slate-500">Projects</div>
            </div>
            <div className="glass rounded-xl p-4 text-center">
              <div className="text-2xl font-bold text-indigo-400">
                {stats.technologiesUsed}+
              </div>
              <div className="mt-1 text-xs text-slate-500">Technologies</div>
            </div>
          </div>
        </motion.div>
      </div>
